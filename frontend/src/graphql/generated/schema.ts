...
export type GetAllCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, emoji: string, id: number, code: string }> };
...
export type AddCountryMutation = { __typename?: 'Mutation', addCountry: { __typename?: 'Country', emoji: string, id: number, name: string } };
